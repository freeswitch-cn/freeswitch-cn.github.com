...
Post-expand include size: 51101/2097152 bytes
Template argument size: 353/2097152 bytes
Expensive parser function count: 0/100
-->

<!-- Saved in parser cache with key wiki:pcache:idhash:1645-0!1!0!!en!2!edit=0 and timestamp 20111215041824 -->
<div class="printfooter">
Retrieved from "<a href="http://wiki.freeswitch.org/wiki/Channel_Variables">http://wiki.freeswitch.org/wiki/Channel_Variables</a>"</div>
			<div id='catlinks' class='catlinks'><div id="mw-normal-catlinks"><a href="/wiki/Special:Categories" title="Special:Categories">Categories</a>:&#32;<span dir='ltr'><a href="/wiki/Category:Configuration" title="Category:Configuration">Configuration</a></span> | <span dir='ltr'><a href="/wiki/Category:Integration" title="Category:Integration">Integration</a></span></div></div>			<!-- end content -->
	...
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				 ...
				 <li id="ca-nstab-main" class="selected"><a href="/wiki/Channel_Variables" title="View the content page [c]" accesskey="c">Page</a></li>
				 <li id="ca-talk" class="new"><a href="/index.php?title=Talk:Channel_Variables&amp;action=edit&amp;redlink=1" title="Discussion about the content page [t]" accesskey="t">Discussion</a></li>
				 <li id="ca-viewsource"><a href="/index.php?title=Channel_Variables&amp;action=edit" title="This page is protected.&#10;You can view its source [e]" accesskey="e">View source</a></li>
				 <li id="ca-history"><a href="/index.php?title=Channel_Variables&amp;action=history" title="Past versions of this page [h]" accesskey="h">History</a></li>			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Channel_Variables" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
	<div class="portlet" id="p-logo"><br/>
		<a style="background-image: url(/skins/common/images/fs_logo.png);" href="/wiki/Main_Page" title="Visit the main page [z]" accesskey="z"></a>
<!--        <a href="http://www.cudatel.com"><img src="/files/Cudatel_banner_210x105.png" width="150"> </a> -->
<!--        <a href="http://www.freeswitchsolutions.com"><img src="/files/FSS-professional-support.png" width="150"></a> -->
	</div>
<br/>
    <div>
    </div>
	...
	<div id="p-search" class="portlet">
		...
		<div id="searchBody" class="pBody">
			<form action="/wiki/Special:Search" id="searchform"><div>
				<input id="searchInput" name="search" type="text" title="Search FreeSWITCH Wiki [f]" accesskey="f" value="" />
				<input type='submit' name="go" class="searchButton" id="searchGoButton"	value="Go" title="Go to a page with this exact name if exists" />&nbsp;
				<input type='submit' name="fulltext" class="searchButton" id="mw-searchButton" value="Search" title="Search the pages for this text" />
			</div></form>
		</div>
	</div>
	<div class='generated-sidebar portlet' id='p-Start_Here'>
		<h5>Start Here</h5>
		<div class='pBody'>
			<ul>
				<li id="n-Download-FreeSWITCH"><a href="/wiki/Download_FreeSWITCH">Download FreeSWITCH</a></li>
				<li id="n-Installation-Guide"><a href="/wiki/Installation_Guide">Installation Guide</a></li>
				<li id="n-Getting-Started-Guide"><a href="/wiki/Getting_Started_Guide">Getting Started Guide</a></li>
			</ul>
		</div>
	</div>
	<div class='generated-sidebar portlet' id='p-Quick_Reference'>
		<h5>Quick Reference</h5>
		<div class='pBody'>
			<ul>
				<li id="n-API-Commands"><a href="/wiki/Mod_commands">API Commands</a></li>
				<li id="n-Dialplan-Applications"><a href="/wiki/Mod_dptools">Dialplan Applications</a></li>
				<li id="n-Channel-Variables"><a href="/wiki/Channel_Variables">Channel Variables</a></li>
				<li id="n-XML-Dialplan"><a href="/wiki/Dialplan_XML">XML Dialplan</a></li>
				<li id="n-SIP-Configuration"><a href="/wiki/Sofia.conf.xml">SIP Configuration</a></li>
				<li id="n-Event-Socket"><a href="/wiki/Mod_event_socket">Event Socket</a></li>
				<li id="n-T1.2FE1.2FAnalog-Cards"><a href="/wiki/FreeTDM">T1/E1/Analog Cards</a></li>
	...
	<div class='generated-sidebar portlet' id='p-Community'>
		...
		<div class='pBody'>
			<ul>
				...
				<li id="n-Get-Involved"><a href="/wiki/Misc_howcanhelp">Get Involved</a></li>
			</ul>
		</div>
	</div>
	<div class='generated-sidebar portlet' id='p-Navigation'>
		...
		<div class='pBody'>
			<ul>
				...
				<li id="n-currentevents"><a href="/wiki/FreeSWITCH_Wiki:Current_events" title="Find background information on current events">Current events</a></li>
				<li id="n-recentchanges"><a href="/wiki/Special:RecentChanges" title="The list of recent changes in the wiki [r]" accesskey="r">Recent changes</a></li>
				<li id="n-help"><a href="/wiki/Help:Contents" title="The place to find out">Help</a></li>
				<li id="n-How-Can-I-Help.3F"><a href="/wiki/Misc_howcanhelp">How Can I Help?</a></li>
			</ul>
		</div>
	</div>
