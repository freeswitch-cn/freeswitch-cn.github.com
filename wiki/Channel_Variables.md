...
<p>- 通常，通道变量对会话是全局的.也就是说，通道变量只要设置一次，便可存在于整个会话中.<br />
...
<a name="Using_Channel_Variables_in_Dialplan_Condition_Statements" id="Using_Channel_Variables_in_Dialplan_Condition_Statements"></a><h3> <span class="mw-headline"> 在拨号计划条件表达式中使用通道变量 </span></h3>
<p>
</p>
